...
@Autonomous(name = "Leave Only RED (FSM + Save Pose)", group = "Autonomous")
public class LeaveOnly2 extends CommandOpMode {
    ...
    // ================= Poses =================
    private final Pose startPose = new Pose(56, 8, Math.toRadians(90)).mirror();
